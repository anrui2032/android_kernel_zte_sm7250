...
#define USB3_QSERDES_TXA_TXA_TX_DRV_LVL_6350_1 0x121c
#define USB3_QSERDES_TXA_TXB_TX_DRV_LVL_6350_1 0x161c
...
#define USB_TUNING_REG_SIZE_6350 12
static int diagram_param_read_6350(char *buf, const struct kernel_param *kp)
{
	int i = 0;
	u32 reg[USB_TUNING_REG_SIZE_6350] = {0x1220, 0x1620, 0x121c, 0x161c, 0x120C, 0x160C, 0x14D4, 0x18D4,
	...
	char *name[USB_TUNING_REG_SIZE_6350] = {
		...
		"USB3_QSERDES_TXA_TXA_TX_DRV_LVL_6350_1",
		"USB3_QSERDES_TXA_TXB_TX_DRV_LVL_6350_1",
