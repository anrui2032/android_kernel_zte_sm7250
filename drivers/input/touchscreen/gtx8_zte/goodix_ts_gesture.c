...
static int __gsx_gesture_before_suspend(struct goodix_ts_core *core_data)
{
...
re_send_ges_cmd:
	__gsx_gesture_before_suspend(core_data);
	...
	struct goodix_ext_module *module)
{
	...
	ret = __gsx_gesture_before_suspend(core_data);
